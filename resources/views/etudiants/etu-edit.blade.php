                ...
                <div class="card-body">
                    <form method="POST" action="/edit/etudiant">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ $etudiant->first_name }}" required autocomplete="first_name" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $etudiant->phone }}" required autocomplete="phone">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="login" type="text" class="form-control @error('login') is-invalid @enderror" name="login" value="{{ $etudiant->login }}" required autocomplete="login">
                            </div>
                        </div>
