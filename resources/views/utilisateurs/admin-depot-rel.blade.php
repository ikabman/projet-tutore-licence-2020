...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-warning">Demandes <i class="fas fa-file-invoice icon-etape-style"></i></h6>
        </div>
        <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($Rel_depots as $rel)
                                    <tr id="{{$rel->id}}">
                                        ...
                                        <td>
                                            <button type="button" value="releve:{{$rel->id}}:{{$rel->etape_id}}:{{$rel->etudiant_id}}" class="btn btn-warning btn-sm float-md-right text-white text-bold passer_etape_unique_btn">
                                                Passer l'étape
                                                <i class="fas fa-angle-double-right"></i>
                                            </button>
                                        </td>
