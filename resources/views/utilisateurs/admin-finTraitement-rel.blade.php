    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-striped border-left-success " id="tableDemandes" width="100%" cellspacing="0">
                    @if($nRel_traites > 0)
                        <!--titres du tableau -->
                        ...
                        <tbody>
                            @foreach ($Rel_traites as $rel)
                                <tr id="{{$rel->id}}">
                                    ...
                                    <td>
                                        <button type="button" value="releve:{{$rel->id}}:{{$rel->etape_id}}::{{$rel->etudiant_id}}" class="btn btn-success btn-sm float-md-right text-white text-bold passer_etape_unique_btn">
                                            Passer l'étape
                                            <i class="fas fa-angle-double-right"></i>
                                        </button>
                                    </td>
