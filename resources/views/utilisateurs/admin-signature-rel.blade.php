...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-info">Signature <i class="fas fa-signature icon-etape-style"></i></h6>
        </div>
        <div class="card-body">
            <div class="row search-sort-box">
                ...
                <div class="col-lg-3">
                    <button type="button" class="btn btn-info btn-md float-md-right text-white text-bold passer_etape_groupe_btn"
                    style="display:none">
                        Passer l'etape
            ...
            <div class="table-responsive">
                <table class="table table-sm table-striped border-left-info " id="tableDemandes" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($Rel_signatures as $rel)
                                <tr id="{{$rel->id}}">
                                    ...
                                    <td>
                                        <button type="button" value="releve:{{$rel->id}}:{{$rel->etape_id}}:{{$rel->etudiant_id}}" class="btn btn-info btn-sm float-md-right text-white text-bold passer_etape_unique_btn">
                                            Passer l'etape
                                            <i class="fas fa-angle-double-right"></i>
                                        </button>
                                    </td>
